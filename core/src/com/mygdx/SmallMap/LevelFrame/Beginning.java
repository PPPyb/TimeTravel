...
public class Beginning {
    ...
    static final int endCnt = 11225;
    TextureRegion[] begin;
    Animation beginAni;
    TextureRegion curFrame;
    float stateTime = 0;

    public Beginning(WorldController worldController)
    {
    ...
    public void initAnime() {
        ...
        begin = new TextureRegion[1226];

        for(int i = startCnt;i <= endCnt;i++)
        {
            Texture temp = new Texture(Gdx.files.internal("begin/"+i+".png"));
